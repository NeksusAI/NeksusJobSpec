...
def _full_spec() -> JobSpec:
    data = {
        ...
        "job": {
            ...
            "apply": {"method": "external_url", "label": "Apply Now", "url": "https://example.com/apply"},
        },
        "components": [
            {"type": "header_brand", "id": "hb", "brand_name": "ACME"},
            {"type": "header_actions", "id": "ha", "actions": [{"label": "Apply", "url": "https://example.com/apply"}]},
            {"type": "hero_banner", "id": "hero-banner", "image_url": "https://example.com/map.png"},
            {"type": "hero", "id": "hero", "title": "Platform Engineer", "subtitle": "Copenhagen"},
            {"type": "meta_chips", "id": "chips", "items": [{"label": "Location", "value": "Copenhagen"}]},
            {"type": "rich_text", "id": "about", "title": "Overview", "body": "Build reliable systems."},
            {"type": "feature_grid", "id": "resp", "items": [{"title": "Own services", "body": "Deliver stable APIs"}]},
            ...
            {"type": "contact", "id": "contact", "name": "Hiring Team", "email": "jobs@example.com"},
            {"type": "meta_panel", "id": "meta", "facts": [{"label": "Team", "value": "Platform"}]},
            {"type": "social_links", "id": "social", "links": [{"label": "LinkedIn", "url": "https://example.com", "icon": "share"}]},
